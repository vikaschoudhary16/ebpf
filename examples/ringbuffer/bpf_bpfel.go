...
type bpfMapSpecs struct {
	QueryRedirectionConfig *ebpf.MapSpec `ebpf:"query_redirection_config"`
}
...
// It can be passed to loadBpfObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfMaps struct {
	QueryRedirectionConfig *ebpf.Map `ebpf:"query_redirection_config"`
}

func (m *bpfMaps) Close() error {
	return _BpfClose(
		m.QueryRedirectionConfig,
	)
}
